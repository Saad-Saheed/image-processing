...
describe('Testing Main Image processing endpoints', function () {
    ...
    it('test /api//image/process endpoint response', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api//image/process?filename=fjord&width=210&height=210')];
                case 1:
                    response = _a.sent();
